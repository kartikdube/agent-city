  ...
  return (
    <div className="space-y-12 animate-in fade-in duration-1000">
      <div className="max-w-3xl mx-auto text-center space-y-4">
        <h2 className="text-4xl font-bold tracking-tight text-white uppercase">Governor Scenario <span className="text-blue-500 font-black">Matrix</span></h2>
      ...
      <div className="flex justify-center border-t border-slate-800/50 pt-12">
        <div className="flex gap-12 items-center text-slate-500 grayscale opacity-40 hover:grayscale-0 hover:opacity-100 transition-all duration-700">
